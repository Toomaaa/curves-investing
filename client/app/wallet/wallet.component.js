    ...
    function getEquities() {
      ...
      $http.get('/api/trades/wallet')
        .then(response => {
          ...
          $scope.wallet.equities.forEach(equity => {

            ////////////////////////////////////////////////////////////
            // Ici aller chercher les infos actuelles du cours
            ////////////////////////////////////////////////////////////
            equity.actualPrice = 99.99;
            ////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////
            ...
            $scope.wallet.total.actual += equity.quantity*99.99;
          });
...
WalletComponent.$inject = ["$scope", "$http"];
